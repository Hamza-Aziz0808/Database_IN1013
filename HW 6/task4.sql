...
WHERE restStaff.staff_no = (
    SELECT DISTINCT restRoom_management.headwaiter
    FROM restRoom_management
    JOIN restRest_table 
      ON restRoom_management.room_name = restRest_table.room_name
    WHERE restRest_table.table_no = (
...
SELECT restBill.cust_name, restStaff.first_name AS headwaiter_first_name, 
       restStaff.surname AS headwaiter_surname, restRest_table.room_name
FROM restBill
JOIN restRest_table 
